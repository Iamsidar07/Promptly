  ...
  return (
    <section className='w-full max-w-5xl space-y-4 mx-auto mb-8'>
      ...
      <form onSubmit={handleSubmit} className='mt-8 flex flex-col space-y-2 w-full'>
        ...
        <textarea
          className='focus:outline-none focus:ring-0 focus:border-black border border-gray-200 rounded-md p-2 pl-4 bg-white font-poppins shadow-sm'
        ...
        <label className='font-semibold'>
          tags{' '}
          <span className='text-gray-500 font-light'>separated tags by ,</span>
        </label>
        <input
          className='focus:outline-none focus:ring-0 focus:border-black border border-gray-200 rounded-md p-2 bg-white font-poppins shadow-sm pl-4'
